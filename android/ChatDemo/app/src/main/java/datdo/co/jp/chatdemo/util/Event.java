...
public class Event {
    ...
    public static final String CHAT_ON_NEW_ROOM     = Event.class + "#CHAT_ON_NEW_ROOM";
    public static final String CHAT_ON_NEW_MESSAGE  = Event.class + "#CHAT_ON_NEW_MESSAGE";
}
